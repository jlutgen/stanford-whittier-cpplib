...
const TestEntry TESTS[] = {
   { "fileliblibrary", testFilelibLibrary },
   ...
   { "foreachstatement",  testForeachStatement }
};
...
int main() {
   setConsolePrintExceptions(true); // JL
